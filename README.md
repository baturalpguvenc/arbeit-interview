...
<p align="center">
  <a href="https://twitter.com/pstructislamist">
    <img src="https://img.shields.io/twitter/follow/pstructislamist?style=flat&label=Follow&logo=twitter&color=0bf&logoColor=fff" alt="Baturalp's follower count" />
  </a>
  <a href="https://github.com/baturalpguvenc/arbeit-interview">
  </a>
</p>
...
Arbeit Studio Liftoff is an interview preparation tool that provides AI feedback on your mock interviews.


You can also clone & create this repo locally with the following command:

```bash
npx create-next-app liftoff --example "https://github.com/baturalpguvenc/arbeit-interview"
```
